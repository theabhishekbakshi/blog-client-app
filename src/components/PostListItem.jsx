  ...
  return (
    <div className='flex flex-col xl:flex-row gap-8 mb-12'>
      ...
      {post.img && <div className="md:hidden xl:block xl:w-1/3">
        <MyImage src={post.img} className="rounded-2xl object-cover" w="735"/>
      </div>}
      {/* details */}
      <div className='flex flex-col gap-4 xl:w-2/3'> 
        <Link to={`/${post.slug}`} className='text-4xl font-semibold hover:text-blue-800 hover:underline'>{post.title}</Link>

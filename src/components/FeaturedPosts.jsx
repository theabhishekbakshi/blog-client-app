  ...
  return (
    <div className='mt-8 flex flex-col lg:flex-row gap-8'>
      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        {/* image */}
        {posts[0].img && <MyImage src={posts[0].img} className="rounded-3xl object-cover" w="895"/>}
        {/* details */}
      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        ...
        {posts[1] && <div className="lg:h-1/3 flex justify-between gap-4">
          {posts[1].img && <div className='w-1/3 aspect-video'>
              <MyImage src={posts[1].img} className="rounded-3xl object-cover w-full h-full" w="298"/>
          </div>}
            {/* details and title */}
            <div className="w-2/3">
                {/* details */}
                ...
                {/* title */}
                <Link className='text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium ' to={posts[1].slug} >{posts[1].title}</Link>
            </div>
        </div>}
        {/* third */}
        {posts[2] && <div className="lg:h-1/3 flex justify-between gap-4">
            {posts[2].img && <div className='w-1/3 aspect-video'>
              <MyImage src={posts[2].img} className="rounded-3xl object-cover w-full h-full" w="298"/>
            </div>}
            {/* details and title */}
            <div className="w-2/3">
                {/* details */}
                ...
                {/* title */}
                <Link className='text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium ' to={posts[2].slug} >{posts[2].title}</Link>
            </div>
        </div>}
        {/* fourth */}
        {posts[3] && <div className="lg:h-1/3 flex justify-between gap-4">
            {posts[3].img && <div className='w-1/3 aspect-video'>
              <MyImage src={posts[3].img} className="rounded-3xl object-cover w-full h-full" w="298"/>
            </div>}
            {/* details and title */}
            <div className="w-2/3">
                {/* details */}
                ...
                {/* title */}
                <Link className='text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium ' to={posts[3].slug} >{posts[3].title}</Link>
            </div>
        </div>}
      </div>
    </div>
